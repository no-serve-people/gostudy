...
type ParallerRunner struct {
	workers    int
	quitMethod quitMethod
}

// SetParallelRunner represents the runner configuration setter
type SetParalleRunner func(runner *ParallerRunner)

// NewParallelRunner creates a new ParallelRunner

func NewParallelRunner(workers int, configurations ...SetParalleRunner) *ParallerRunner {
	runner := &ParallerRunner{workers: workers}
...
func QuitOnError() SetParalleRunner {
	return func(runner *ParallerRunner) {
		runner.quitMethod = quitOnError
	}
}

// QuitWhenAllFinished sets runner quit when all request are finished
func QuitWhenAllFinished() SetParalleRunner {
	return func(runner *ParallerRunner) {
...
func (pr ParallerRunner) Run(ctx context.Context, inputs []interface{}, worker func(context.Context, interface{}) (interface{}, error)) ([]interface{}, []error) {
	var (
		outputs     []interface{}
		errors      []error
